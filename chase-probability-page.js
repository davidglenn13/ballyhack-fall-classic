  ...
  board=function(){
    ...
    `:`
      <section class="card">
        <div class="eyebrow">TOURNAMENT OUTLOOK</div>
        <h2 class="red">Chase for the Cup — Forecast</h2>
        <p>Current chance to win or finish in the money. Completed scores are fixed; remaining golf is simulated 15,000 times using a neutral scoring baseline that gradually blends in each golfer’s tournament form as more holes are played. “In the money” means 1st, 2nd, or 3rd; cutoff ties count.</p>
      </section>
    `;
