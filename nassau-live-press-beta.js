...
(() => {
  ...
  function enhanceScore(){
    ...
    if(existingCard){
      if(existingWager&&typeof sideGameWasSelected==='function'&&sideGameWasSelected(r,g)){existingWager.classList.add('side-game-wager-detached');existingCard.insertAdjacentElement('afterend',existingWager);}
      return;
    }
