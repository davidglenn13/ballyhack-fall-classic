...
export async function onRequestPost({request,env}){
  if(!same(request.headers.get('x-beta-reset-secret')||'',RESET_SECRET))return Response.json({error:'Not found'},{status:404});
...
export function onRequestGet(){return new Response('Not found',{status:404})}
